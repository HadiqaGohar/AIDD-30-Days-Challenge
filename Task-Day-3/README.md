...
Gemini 3.0 brings state-of-the-art reasoning depth, substantially stronger multimodal understanding (text, image, video, audio and code), and new model behaviors like media-resolution handling, “thought signatures” and configurable thinking levels all exposed with updated API parameters.
...
First, upgrade the Gemini CLI globally
...
<img width="1212" height="706" alt="image" src="https://github.com/user-attachments/assets/6e5f98e1-b0c4-445e-a3a0-859958ad2881" />

##### Finally, check that ‘PRO’ appears in the bottom-right corner.

<img width="906" height="506" alt="image" src="https://github.com/user-attachments/assets/e44673b2-7035-4c13-8d4e-5a14dacb3a3b" />
